function varargout=otsigtrnschld2(fname, pfunc),
...
% $Id: otsigtrnschld2.m 180 2011-05-19 09:34:28Z Katura $
% Reversion 1.0:
%   23-Dec-2005
%   Inport from 
%       :: otsigtrnschld.m,v 1.8 2005/12/13 02:40:59 shoji Exp
  ...
  switch (basic_info.IO_Kind),
   case 0,
    ...
    DataDef_SignalPreprocessor('save');	% OLD-MODE
   ...
   case 1,
    ...
    DataDef_SignalPreprocessor('save',hdata,data);

   otherwise,
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % Undefined I/O Kind
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%
    error(['Undefined : I/O Kind : ' ...
	   func2str(pfunc)]);
  end % Switch I/O Kind

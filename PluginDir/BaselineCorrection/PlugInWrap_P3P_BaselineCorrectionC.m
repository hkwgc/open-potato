function varargout=PlugInWrap_P3P_BaselineCorrectionC(fnc,varargin)
% Filter Plug-in
%
                                                                                       
% Edit the above text to modify the response to help PlugInWrap_P3P_BaselineCorrectionC
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
bi.name='Baseline correction (Continuous)';
bi.Version=1.0;
bi.region= 2 ;
bi.DispKind=0;
return;
...
%      argData.Deg : Degree of polynomial fitting for baseline estimation. (Character)
%      argData.IgP : Period to be ignored in baseline estimation (point) (Character)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% write M-Script to perform Baseline correction (Continuous)

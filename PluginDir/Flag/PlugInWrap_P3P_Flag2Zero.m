function varargout=PlugInWrap_P3P_Flag2Zero(fnc,varargin)
% Filter Plug-in
%
                                                                             
% Edit the above text to modify the response to help PlugInWrap_P3P_Flag2Zero
...
% write M-Script to perform Flag to zero

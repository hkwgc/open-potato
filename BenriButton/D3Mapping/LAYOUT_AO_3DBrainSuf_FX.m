function varargout=LAYOUT_AO_3DBrainSuf_FX(fnc,varargin)
...
% $Id: LAYOUT_AO_3DBrainSuf_FX.m 180 2011-05-19 09:34:28Z Katura $

% == History =-
% 2010/02/20 :: Copy & modify from LAYOUT_AO_2DImage.m .
% 2010/10/27 mod by TK
...
% get Basic Info
info.MODENAME='3D BrainSurf FX';
info.fnc     ='LAYOUT_AO_3DBrainSuf_FX';
info.ver     = 0.0;
info.ccb     = {};
return;
...
str=[...
  'LAYOUT_AO_3DBrainSuf_FX(''draw'', h.axes,', ...
  ' curdata, obj{idx})'];
return;

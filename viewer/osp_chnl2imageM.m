function [c, x, y] = osp_chnl2imageM(ydata, header, image_mode, v_interpstep, v_interpmethod)
% function [c, x, y] = osp_chnl2imageM(ydata, header, image_mode,smooth,smooth method)
% IN:
%    ydata: (1, ch)
...
% create : 2005.08.12
% $Id: osp_chnl2imageM.m 180 2011-05-19 09:34:28Z Katura $
...
switch probe_mode,
  ...
  case 1,
    ydata=osp_chnl2image(ydata,probe_mode, image_mode, ...

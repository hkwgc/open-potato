function varargout = uiTtest(varargin)
% UITTEST M-file for uiTtest.fig
%      UITTEST, by itself, creates a new UITTEST or raises the existing
%      singleton*.
%
%      H = UITTEST returns the handle to a new UITTEST or the handle to
%      the existing singleton*.
%
%      If you want to chaneg Using Data or Start up UITTEST, 
%      set value that used in UITTEST. To Set Value 
%      UITTEST('SetValue',hObject,[],handles, ...
...
%          getappdata(uiTtest)
%
%      UITTEST('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in UITTEST.M with the given input arguments.
%
%      UITTEST('Property','Value',...) creates a new UITTEST or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before uiTtest_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to uiTtest_OpeningFcn via varargin.
%
...
% Last Modified by GUIDE v2.5 30-May-2005 19:13:40
...
% create : 2005.03.03
% $Id: uiTtest.m 180 2011-05-19 09:34:28Z Katura $

% Reversion 1.11
%   Change view for Position Data

if (nargin==1),
  strcmp('createBasicInfo',varargin{1});
  varargout{1}='Display Name';
  if narargout==1, return;  end
  varargout{2}=1; % Type of S
  if narargout==2, return;  end
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @uiTtest_OpeningFcn, ...
                   'gui_OutputFcn',  @uiTtest_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function uiTtest_OpeningFcn(hObject, eventdata, handles, varargin)
%----------------------------------------------------------------
...
function varargout = uiTtest_OutputFcn(hObject, eventdata, handles)
%----------------------------------------------------------------

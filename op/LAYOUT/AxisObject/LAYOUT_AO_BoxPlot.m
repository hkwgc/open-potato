function varargout=LAYOUT_AO_BoxPlot(fnc,varargin)
%- ver 1.0 2011/05/16 TK@HAR
...
% get Basic Info
  info.MODENAME='Box Plot';
  info.fnc     ='LAYOUT_AO_BoxPlot';
...
% make data & Draw
%===========================
R = P3_subFiveNumberSummaries(data(:,:,curdata.kind(1)),gca);
xlim([-0.5 0.5])

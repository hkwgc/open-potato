function varargout=PlugInWrap_MergeSearchIndex(fnc,varargin)
% Filter Plug-in
%
                                                                                
% Edit the above text to modify the response to help PlugInWrap_MergeSearchIndex
...
% write M-Script to perform Merge Search Index
...
% ======================================
make_mfile('with_indent',...
           'hdata=P3P_MergeSearchIndex(hdata);');

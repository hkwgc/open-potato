function varargout = PlugInWrap_sd(fcn, varargin)
...
%       DispKind :: Add Kind
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
basicInfo.name   = 'Test-Function of 1st-Lvl-Ana(SD)';
basicInfo.region = 3;
% ==> Version : Must be
ver = '$Revision: 1.1 $';
ver([1:13,end])=[];
...
% Exeute
make_mfile('with_indent',['[fhdata,fdata] = flafnc_sd(''make'',hdata,data,' fdata.argData.HOGE ');']);

function varargout=flafnc_SimpleTTest(fcn,varargin)
...
if iscell(hdata.TAGs.filename), hdata.TAGs.filename = hdata.TAGs.filename{1};end
[t tt t]=fileparts(hdata.TAGs.filename);
fhdata.name=tt;

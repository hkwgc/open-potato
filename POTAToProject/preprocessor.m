...
% PREPROCESSOR Application M-file for preprocessor.fig
%    FIG = PREPROCESSOR launch preprocessor GUI.
%    PREPROCESSOR('callback_name', ...) invoke the named callback.

% Last Modified by GUIDE v2.5 06-Dec-2006 11:12:26
% $Id: preprocessor.m 180 2011-05-19 09:34:28Z Katura $
%
% Revision 1.12
...
% ================================
  ...
  %   is Project-Directory.
  %%cd(pj.Path);
  openpath=[pj.Path filesep pj.Name];
  cd(openpath); 
  % --> Current 
  % [fn pn]=uigetfile('*.dat');

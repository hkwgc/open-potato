function varargout=Plugin2ndLvlAna_GrubbsSmirnov(fcn,varargin)
% Grubbs-Smirnov Test
%  :: This is Test-Function of 2nd-Level-Analysis.
%
%-----------------------
% $Id: Plugin2ndLvlAna_GrubbsSmirnov.m 180 2011-05-19 09:34:28Z Katura $
%-----------------------
...
basicInfo.name   = 'Grubbs-Smirnov test'; % Print Name
...
bi= createBasicInfo;
str={...
  ' Grubbs-Smirnov Test (Sample Plugin of 2nd-Lvl-Ana.)',...
  ' ====================================================',...
  '  Number of Group : 1',...
  '',...
  '  -- Group 1 --',...
  '     Type of 1st-Lvl-Ana : any type in current',...
  sprintf('     Version             : %6.2f',bi.Version),...
  '',...
  ' ====================================================',...
  '  Test :  is max/min value of the group far off the mark?',...
  ' ----------------------------------------------------',...
  '  Note :  Normal population is required.',...
...
group1.name     = 'Test';
group1.function = 'flafnc_mean'; % <- Basic
data0.group={group1};
return;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if nargin==0
  error('Grubbs-Smirnov Test Need 1-Group at least.');
end
